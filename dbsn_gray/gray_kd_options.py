...
parser.add_argument("--log_name", type=str, default="gray_dbsn", help="file name for save")
parser.add_argument("--noise_type", type=str, default="gaussian", help="set the noise type")
parser.add_argument("--dbsn_ckpt",type=str,default='./models/gray_gaussian_nL25.pth',help="the pre-trained DBSN model for image synthesis")
# data
parser.add_argument("--dataroot", type=str, default="", help="path to set")
parser.add_argument("--trainset", type=str, default="div2k,wed4744", help="training set name")
...
#
parser.add_argument("--patch_size", type=int, default=160, help="the patch size of input")
...
parser.add_argument("--lr_dbsn", type=float, default=0, help="the initial learning rate of backbone network")
parser.add_argument("--lr_sigma_mu", type=float, default=0, help="the initial learning rate of net_sigma_mu")
parser.add_argument("--lr_sigma_n", type=float, default=0, help="the initial learning rate of net_sigma_n")
parser.add_argument("--lr_cnn_denoiser", type=float, default=1e-6, help="the initial learning rate of net_sigma_n")
...
# additional
parser.add_argument("--gamma",type=float,default=1,help="additional parameter for MAP inference")
parser.add_argument("--isPretrain",type=str2bool,default=True,help="aif using the pre-trained model for warm start")
parser.add_argument("--pretrained_cnn_denoiser_path",type=str,default='./models/mwcnn_poisson_gaussian_s40_c10.pth',help="aif using the pre-trained model for warm start")
