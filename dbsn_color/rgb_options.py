...
parser.add_argument("--finetune", type=str2bool, default=True, help="if using the pre-trained model for finetune")
# data
parser.add_argument("--dataroot", type=str, default="", help="path to set")
parser.add_argument("--trainset", type=str, default="set14,bsd500,mcmaster,kodak24,imagenet_val", help="path to set")
parser.add_argument("--valset", type=str, default="cbsd68", help="path to set")
#
