...
from net.losses import MAPLoss_Pretrain, DBSNLoss_Pretrain
...
def main(args):
    ...
    # loss function
    if args.noise_type == 'multivariate_gaussian':
        criterion = DBSNLoss_Pretrain().cuda()
    else:
        criterion = MAPLoss_Pretrain().cuda()
